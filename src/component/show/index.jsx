    ...
    <>
        <section className='no-repeat bg-cover h-full ' style={{ backgroundImage:`url(${img})` }}>
            <div className="container mx-auto relative p-6 md:p-0 md:py-10">
                ...
                <div className="img w-auto  md:w-[200px] lg:w-[280px] lg:max-w-[340px] h-40 xl:w-[340px] relative md:absolute right-0 sm:h-72 lg:h-[420px] md:top-10 lg:top-20 border p-6 rounded-md">
                    {/* <picture> */}
                    ...
                    <a href="#">
                        <span class="relative flex  h-14 w-14 top-0 left-1/2  -translate-x-1/2 text-white text-6xl  text-center rounded-full -translate-y-[200%] sm:-translate-y-[280%] lg:-translate-y-[380%] z-50">
                            <span class="animate-ping absolute top-1/2 inline-flex h-full w-full rounded-full bg-lightGreen "></span>
                            <span className='absolute top-full left-1/2 -translate-x-1/2 text-white text-6xl bg-lightGreen/25 w-20 h-20 text-center rounded-full -translate-y-1/2 z-50'>
