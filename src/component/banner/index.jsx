    ...
    <>
      <section className='bg-dark pt-36 ' id='home'>
        <div className="container mx-auto relative">
          <h2 className='font-mulish font-[950] text-[78px] sm:text-[100px] md:text-[140px] lg:text-[180px] xl:text-[260px] textStroke leading-[.9]'> <TextAnimation2 text='FULL'/> </h2>
          <h2 className='font-mulish lg:my-8 font-[950] text-[78px] sm:text-[100px] md:text-[140px] lg:text-[160px] xl:text-[260px]  stackStroke text-center leading-[1.2] sm:leading-[.9] md:leading-[.9] lg:leading-[.9] flex items-center justify-center'> <TextAnimation2 text='STACK'/> <span style={{background:`url(${bg})`,backgroundRepeat:'no-repeat',backgroundSize:'cover'}} className='shadow-2xl shadow-orangeRed/5  cursor-pointer w-14 h-14 sm:w-14 sm:h-14  md:w-24 md:h-24 lg:w-24 lg:h-24 xl:w-40 xl:h-40 bg-black rounded-full flex justify-center items-center xl:text-[120px] after:w-[110%] after:h-[110%] after:absolute after:top-1/2 after:-translate-y-1/2 after:rounded-full after:border-4 after:border-lightGreen after:shadow-xl after:shadow-black after:z-[-1] z-[10] relative'> <IoIosPlay className="inline-block text-white" /></span>
          </h2>
          <h2 className='font-mulish font-[950] text-[62px] sm:text-[100px] md:text-[120px] lg:text-[140px] xl:text-[200px] 2xl:text-[240px] pt-0 developerStroke leading-[.9]'><TextAnimation2 text='DEVELOPER'/></h2>
          ...
          <span className='font-kodchasan text-base md:text-4xl font-bold uppercase text-shadowLight absolute bottom-0 sm:bottom-4 lg:bottom-0 left-10 lg:left-6 animate-scale'>JAVASCRIPT</span>
